...
<head>
    ...
    <!-- style switcher css -->
    <link href="{{ asset('css/skins/color-1.css') }}" rel="stylesheet" type="text/css" class="alternate-style"
        title="color-1">
    <link href="{{ asset('css/skins/color-2.css') }}" rel="stylesheet" type="text/css" class="alternate-style"
        title="color-2" disabled>
    <link href="{{ asset('css/skins/color-3.css') }}" rel="stylesheet" type="text/css" class="alternate-style"
        title="color-3" disabled>
    <link href="{{ asset('css/skins/color-4.css') }}" rel="stylesheet" type="text/css" class="alternate-style"
        title="color-4" disabled>
    <link href="{{ asset('css/skins/color-5.css') }}" rel="stylesheet" type="text/css" class="alternate-style"
            ...
            <div class="row full-screen align-items-center">
                ...
                <div class="home-img">
                    <div class="img-box inner-shadow">
                        <img src="{{ asset('../pictures/lanreFace.jpg') }}" alt="profile pix" class="outer-shadow">
                    </div>
    ...
    <section class="about-section section" id="about">
        <div class="container">
            ...
            <div class="row">
                <div class="about-img">
                    <div class="img-box inner-shadow">
                        <img src="../pictures/olumide.jpg" alt="About pix">
                    </div>
                    <div class="social-links">
                        <a href="https://m.facebook.com/lanre.sanni.739" target="_blank"
                            class="outer-shadow hover-in-shadow"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://twitter.com/OluwaEinstein01?t=_vFS_m13tfGQ5kTYFZLDrg&s=09" target="_blank"
                            class="outer-shadow hover-in-shadow"> <i class="fab fa-twitter"></i></a>
                        <a href="https://www.linkedin.com/in/sanni-lanre-686125ba" target="_blank"
                            class="outer-shadow hover-in-shadow"><i class="fab fa-linkedin-in"></i></a>
                        <a href="https://github.com/oluwaeinstein007" target="_blank"
                            class="outer-shadow hover-in-shadow"><i class="fab fa-github"></i></a>
                        <a href="https://alvo.chat/cm" target="_blank" class="outer-shadow hover-in-shadow"><i
                                class="fab fa-whatsapp"></i></a>
                        <a href="sms:{08057322330}?body=Hello Lanre, I have a job for you" target="_blank"
                            class="outer-shadow hover-in-shadow"><i class="fas fa-comment"></i></a>
                    </div>
                </div>
                <div class="about-info">
                    <p><span>Hi! My name is Lanre, I am a Fullstack Software Developer</span> with over 2 years
                        professional experience writing building Mobile and Web Applications with clean and easy to
                        maintain while also managing launched project. <br> I’m single and young (in my 20’s), I have an
                        educational background in Physics. <br> I’m based in Lagos, the commercial center of Nigeria,
                        but I'm open to working remotely/on-site, freelance/full-time for both local and international
                        clients.</p>
                    <a href="{{ asset('../pictures/cv.docx') }}" class="btn-1 outer-shadow hover-in-shadow">Download
                        CV</a>
                            ...
                            <div class="row">
                                ...
                                <div class="timeline-item">
                                    <div class="timeline-item-inner outer-shadow">
                                        ...
                                        <p>I worked at every stage of the development of Tramango OTA, from
                                            brainstorming and project planning to launch, and mainly working on the
                                            Backend of the OTA, creating the OTA API and implementing thirdparty APIs
                                            like Amadeus, Paystack, etc</p>
                                    </div>
                                </div>
                                <!-- timeline item end -->
                                <!-- timeline item start -->
                                <div class="timeline-item">
                                    <div class="timeline-item-inner outer-shadow">
                                        ...
                                        <h4>Balaga</h4>
                                        <p>I led a team to develop Balaga dating app and got involed in every aspect of
                                            the development from brainstorming to launching, and mainly contributed in
                                            the Mobile App of the project</p>
                                    </div>
                                </div>
                                <!-- timeline item end -->
                                <!-- timeline item start -->
                                <div class="timeline-item">
                                    <div class="timeline-item-inner outer-shadow">
                                        ...
                                        <p>I worked as Frontend Course Coordinator, developed React Roadmap, weekly
                                            accessments and projects</p>
                                    </div>
                                </div>
                                <!-- timeline item end -->
                                <!-- timeline item start -->
                                <div class="timeline-item">
                                    <div class="timeline-item-inner outer-shadow">
                                        ...
                                        <p>I build a complete E-Learning App with payment portal for Al Faruq college in
                                            2020 during the lockdown, worked on the Noir lab's noirportal project, and
                                            built GoAhead Homes Web. App.</p>
                                    </div>
                                </div>
                                <!-- timeline item end -->
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="timeline-item">
                                        <div class="timeline-item-inner outer-shadow">
                                            ...
                                            <p>I first got into coding in 2015 learning Java on Bucky Robert's NewBoston
                                                Youtube channel, later acing a Java course in my sophomore year in OAU,
                                                then started learning web development with Traversy media and many other
                                                youtube channels and got serious in my Tech career in 2020</p>
                                        </div>
                                    </div>
                                    <!-- timeline item end -->
                                    <!-- timeline item start -->
                                    <div class="timeline-item">
                                        <div class="timeline-item-inner outer-shadow">
                                            ...
                                            <p>I was lucky to be part of the program twice and getting to second stage
                                                both times</p>
                                        </div>
                                    </div>
                                    <!-- timeline item end -->
                                    ...
                                    <div class="timeline-item">
                                        <div class="timeline-item-inner outer-shadow">
                                            ...
                                            <p>I studied Engineering Physics, a 4 years course, but specialized in
                                                theoretical physics, getting trained in Nuclear physics, Astrophysics,
                                                Mathematical physics, Material Science, Solidstates, Optics, Relativity,
                                                Quantum mechanics, Electromagnetism and Thermodynamics</p>
                                            <a href="{{ asset('../pictures/thesis.pdf') }}"
                                                class="btn-1 outer-shadow hover-in-shadow">View My Thesis</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="timeline-item">
                                            <div class="timeline-item-inner outer-shadow">
                                                ...
                                                <p>I got Certificate of Participation for my part in a team of 8
                                                    Developer building our Mobile clinic entry</p>
                                                <a href="https://storage.cloud.google.com/open-cert.appspot.com/alc/sdg/certs/fb/cohort1/sanniQudusOlanrewaju_cbb5727d-61d1-48c3-a1ad-aea957d699aa.pdf"
                                                    target="_blank" class="btn-1 outer-shadow hover-in-shadow">View My
                                                    Cert.</a>
                                            </div>
                                        </div>
                                        <!-- timeline item end -->
                                        ...
                                        <div class="timeline-item">
                                            <div class="timeline-item-inner outer-shadow">
                                                ...
                                                <p>I got Certificate of Participation for getting to the second stage of
                                                    the program</p>
                                                <a href="https://adscerts.com/scholar/B4D8202DE3C248E6"
                                                    target="_blank" class="btn-1 outer-shadow hover-in-shadow">View My
                                                    Cert.</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-item">
                                            <div class="timeline-item-inner outer-shadow">
                                                ...
                                                <p>I contested to be president of PEPSA (Physics and Engineering Physics
                                                    Student Association) but came in first runner-up</p>
                                            </div>
                                        </div>
                                        <!-- timeline item end -->
                                        <!-- timeline item start -->
                                        <div class="timeline-item">
                                            <div class="timeline-item-inner outer-shadow">
                                                ...
                                                <h4>Department of Physics & Engineering Physics, OAU</h4>
                                                <p>I was elected to be computer coordinator of PEPSA (Physics and
                                                    Engineering Physics Student Association) in charge of all the
                                                    computer assests of the Student Association, and I upgraded all our
                                                    web pressence alongside other projects</p>
                                            </div>
                                        </div>
                                        <!-- timeline item end -->
            ...
            <div class="row">
                ...
                <div class="service-item">
                    <div class="service-item-inner outer-shadow">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias nesciunt eos fuga. Provident
                            perspiciatis quaerat, ab rem officia totam, reiciendis dolore consequatur dignissimos quam
                            harum hic sapiente cupiditate suscipit iure.</p>
                    </div>
                </div>
                <!-- service item ends -->
                <!-- service item start -->
                ...
                <div class="portfolio-item" data-category="e-learning">
                    <div class="portfolio-item-inner outer-shadow">
                        <div class="portfolio-item-img">
                            <img src="../pictures/profile.jpeg" alt="Protfolio"
                                data-screenshots="../pictures/profile.jpeg,
                            ...
                            <div class="row">
                                <div class="description">
                                    ...
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore necessitatibus
                                        aliquam laboriosam eum laborum accusamus repudiandae. Asperiores numquam nostrum
                                        voluptate, illum atque fugiat cumque consequatur exercitationem possimus natus
                                        excepturi beatae.</p>
                                </div>
                                <div class="info">
                                    <h3>Project Info:</h3>
                                    <ul>
                                        ...
                                        <li>Web - <span><a href="#" target="_blank"
                                                    rel="noopener noreferrer">www.domain.com</a></span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="testi-slider outer-shadow">
                        <div class="testi-slider-container">
                            ...
                            <div class="testi-item active">
                                ...
                                <p>Lanre is a great individual who is professional and very easy to work with. He makes
                                    himself available to his client. He takes the project given as his own and always
                                    offer solutions to any issues at hand.</p>
                            ...
                            <div class="testi-item">
                                ...
                                <i class="fas fa-quote-left left"></i>
                                <i class="fas fa-quote-right right"></i>
                                <p>Lanre is a self driven Fullstack developer which I have had the opportunity of
                                    working with on certain projects, full of life and ready to find solutions when
                                    stuck.</p>
                            ...
                            <div class="testi-item ">
                                ...
                                <i class="fas fa-quote-left left"></i>
                                <i class="fas fa-quote-right right"></i>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus nesciunt totam
                                    consequuntur fuga dolorum sit accusantium optio minus doloremque iusto, tempora
                                    culpa nobis ducimus asperiores sapiente reprehenderit similique ut quis.</p>
    ...
    <section class="contact-section section" id="contact">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="contact-item">
                    <div class="contact-item-inner outer-shadow">
                        <a href="mailto:slanre26@gmail.com?subject=I have a job for you&body=Hello Lanre"
                            target="_blank" rel="noopener noreferrer"><i class="fas fa-envelope"></i></a>
                        <span>Email</span>
                        <a href="mailto:slanre26@gmail.com?subject=I have a job for you&body=Hello Lanre"
            ...
            <div class="pp-details-inner">
                ...
                <div class="pp-project-details">
                    <div class="row">
                        <div class="description">
                            <h3>Project Brief:</h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore necessitatibus aliquam
                                laboriosam eum laborum accusamus repudiandae. Asperiores numquam nostrum voluptate,
                                illum atque fugiat cumque consequatur exercitationem possimus natus excepturi beatae.
                            </p>
                        </div>
                        <div class="info">
                            <h3>Project Info:</h3>
